...
CREATE TABLE `sp_warehouse` (
  ...
  `default_length` int(11) NULL DEFAULT 50 COMMENT '默认库位长度(cm)',
  `default_width` int(11) NULL DEFAULT 50 COMMENT '默认库位宽度(cm)',
  `default_height` int(11) NULL DEFAULT 50 COMMENT '默认库位高度(cm)',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `create_username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '创建人',
  `update_time` datetime(0) NOT NULL COMMENT '最后更新时间',
  `update_username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '最后更新人',
...
CREATE TABLE `sp_warehouse_location` (
  ...
  `materiel_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '当前存放物料ID',
  `length` int(11) NULL DEFAULT 50 COMMENT '库位长度(cm)',
  `width` int(11) NULL DEFAULT 50 COMMENT '库位宽度(cm)',
  `height` int(11) NULL DEFAULT 50 COMMENT '库位高度(cm)',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `create_username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '创建人',
  `update_time` datetime(0) NOT NULL COMMENT '最后更新时间',
  `update_username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '最后更新人',
...
-- ----------------------------------------------------------------------------
-- 密码使用 Shiro Md5Hash 加密：salt=username + password，迭代3次
...
VALUES
('user_101', '工艺员1', 'user101',  'dbc9aedd389a1690a20e980e00233160', 'dept_process', '', '13800000101', '', '1', '工艺部-工艺员', '0', NOW(), 'admin', NOW(), 'admin'),
('user_201', '计划员1', 'user201',  '04f05b4bcec1dc0227d75a7ca37242c2', 'dept_plan',   '', '13800000201', '', '1', '计划部-计划员', '0', NOW(), 'admin', NOW(), 'admin'),
('user_301', '生产主管1', 'user301', '386d94f6b7e4d8a03e7582d69ba0c41f', 'dept_prod',   '', '13800000301', '', '1', '生产部-生产主管', '0', NOW(), 'admin', NOW(), 'admin'),
('user_302', '作业员1', 'user302',  '8a0a1608b78fed178f110261061aa2e1', 'dept_prod',   '', '13800000302', '', '1', '生产部-生产作业员', '0', NOW(), 'admin', NOW(), 'admin'),
('user_401', '库管员1', 'user401',  '696a9aa781514e414b3c19d6be3c1468', 'dept_purchase', '', '13800000401', '', '1', '采购部-库房管理员', '0', NOW(), 'admin', NOW(), 'admin'),
('user_501', '检验员1', 'user501',  '8e64088c9e607b00d37e706a59f72a7e', 'dept_quality', '', '13800000501', '', '1', '质量部-质量管理员', '0', NOW(), 'admin', NOW(), 'admin');
...
CALL AddColumnIfNotExists('sp_warehouse', '`default_width`', "int(11) NULL DEFAULT 50 COMMENT '默认库位宽度(cm)' AFTER `default_length`");
CALL AddColumnIfNotExists('sp_warehouse', '`default_height`', "int(11) NULL DEFAULT 50 COMMENT '默认库位高度(cm)' AFTER `default_width`");
...
-- 库位物料关联表（支持一个库位存放多种物料及数量）
DROP TABLE IF EXISTS `sp_warehouse_location_materiel`;
CREATE TABLE `sp_warehouse_location_materiel` (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键id',
  `location_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '库位ID',
  `materiel_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '物料ID',
  `quantity` int(11) NOT NULL DEFAULT 1 COMMENT '存放数量',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `create_username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '创建人',
  `update_time` datetime(0) NOT NULL COMMENT '最后更新时间',
  `update_username` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '最后更新人',
  `is_deleted` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '逻辑删除：1 表示删除，0 表示未删除，2 表示禁用',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_location_materiel`(`location_id`, `materiel_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '库位物料关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sp_product_bom` (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键ID',
  `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '产品物料编码',
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '产品物料名称',
  `version` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'V1.0' COMMENT '版本',
  `is_valid` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '1' COMMENT '有效性 0:无效 1:有效',
  `is_frozen` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '定版标识 0:未定版 1:已定版',
  ...
  `is_deleted` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '0' COMMENT '是否删除 0:否 1:是',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_code_version`(`code`, `version`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '产品BOM头表';

DROP TABLE IF EXISTS `sp_product_bom_node`;
CREATE TABLE `sp_product_bom_node` (
  `id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主键ID',
  `bom_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'BOM头ID',
  `parent_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '父节点ID',
  `node_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '节点编号',
  `node_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '节点名称',
  `node_level` int(11) NOT NULL DEFAULT 0 COMMENT '节点层级',
  `node_type` varchar(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '节点类型 1:零部件 2:物料',
  `ref_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '关联编码',
  `ref_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '关联名称',
  `qty` decimal(10, 2) NULL DEFAULT 1 COMMENT '数量',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '产品BOM节点表';
